    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center bg-gradient-to-br from-blue-600 via-indigo-600 to-purple-600 relative overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white p-8 max-w-md">
          <div className="mb-8">
            <div className="inline-flex h-16 w-16 items-center justify-center rounded-2xl bg-white/10 backdrop-blur text-2xl font-bold mb-4">
              OAW
            </div>
        ...
        {/* Decorative elements */}
        <div className="absolute top-1/4 right-1/4 h-32 w-32 rounded-full bg-white/5 blur-3xl" />
        <div className="absolute bottom-1/3 left-1/3 h-24 w-24 rounded-full bg-white/5 blur-2xl" />
      </div>
    </div>
  )
}